...
CONFIG_RUTAS = {
    ...
    r'G:\.shortcut-targets-by-id\1H6coCC4GgCcvOGjxbvwnkh2A1xto5hcc\2026. Granjas\Registros_ Lotes Activos\Agroavicola Chi-Hen_ Registros\PRODUCCION CHIHEN': 'AGROAVICOLA CHI-HEN'
}

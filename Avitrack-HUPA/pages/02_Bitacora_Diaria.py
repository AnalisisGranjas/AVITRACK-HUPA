...
if not df_empresa.empty:
    ...
    with c1:
        granja_sel = st.selectbox("🏘️ Granja", sorted(df_empresa['Nombre de Granja (P) :'].unique()))
    with c2:
    ...
    with c3:
        ...
        # Calendario para filtrar la tabla
        rango = st.date_input("📅 Rango de Fechas", value=(df_f_l['Fecha'].min(), df_f_l['Fecha'].max()))
    ...
    # --- 6. TABS DE GALPONES ---
    lista_galpones = sorted(df_f_l['Galpón'].unique())
